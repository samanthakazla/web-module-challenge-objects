...
function createMenuItem(name, cost, category){
    return obj = {name: name, price: cost,  category: category}
}
...
console.log(createMenuItem("pudding", 5, "dessert"));
console.log(createMenuItem("pannini", 5, "lunch"));
...
reviews.push({
  name:"Sam", 
  rating: 5, 
  feedback:"Really awesome place, definately recommend"
});
